...
public class ClieneListRepositorio extends AbstractaListRepositorio<Cliente> {

    @Override
    public void updateCliente(Cliente cliente) throws LecturaAccesoDatoException {
